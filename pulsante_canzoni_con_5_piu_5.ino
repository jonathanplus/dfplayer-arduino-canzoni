...
void loop() {
  ...
  if (a == 1 && b == 0){ // se a è uguale a 1 e b è uguale a 0 allora fai partire la traccia
         myDFPlayer.play(1);
         delay (8000); // ferma tutto per 8 secondi questo valore lo puoi cambiare in base al tempo della traccia, qundi anche il pulsante verra' escluso per 8 secondi
         myDFPlayer.play(2);
         delay (8000);
         myDFPlayer.play(3);
         delay (8000);
